...
# ✅ GOV.UK logo at the top of the main page
st.markdown(
    """
    <a href="https://newfuturesnetwork.gov.uk" target="_blank">
        <img src="https://newfuturesnetwork.gov.uk/wp-content/themes/govuk-frontend/govuk/assets/images/govuk-logotype-crown.png"
...
# ✅ GOV.UK logo also in the sidebar
st.sidebar.markdown(
    """
    <a href="https://newfuturesnetwork.gov.uk" target="_blank">
        <img src="https://newfuturesnetwork.gov.uk/wp-content/themes/govuk-frontend/govuk/assets/images/govuk-logotype-crown.png"
...
# ✅ Hide Streamlit branding + apply GOV.UK styles
st.markdown(
    """
    <style>
