...
if workshop_size == "Enter dimensions":
    ...
    area_map = {"Small": 400, "Medium": 1000, "Large": 2000}  # approx sq ft
...
if not customer_covers_supervisors and workshop_hours > 0 and contracts > 0:
...
def calculate_host_costs():
    ...
    if workshop_type in workshop_energy:
        ...
        hours_factor = workshop_hours / 37.5  # prorate by hours open
